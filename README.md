...
**8 Visuals:**
1. KPI Cards — Revenue, Orders, Customers, Avg Order Value, Revenue per Customer
2. Area Chart — Monthly Revenue Trend (with holiday annotation)
3. Donut Chart — Customer Segment Distribution
4. Segment Summary Table — with conditional formatting on Revenue
5. Filled Map — Revenue by Country
6. RFM Scatter Plot — Recency vs Monetary, bubble size = Frequency
7. Product Revenue Treemap — Top 20 products by revenue
8. Gauge Chart — Repeat Customer Rate vs 70% target
...
- Dataset: [Carrie1 on Kaggle](https://www.kaggle.com/datasets/carrie1/ecommerce-data) — UK Online Retail Dataset
